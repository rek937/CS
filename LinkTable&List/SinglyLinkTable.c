...
* 2. The incoming variable 'len' reprensents the length of the array(which must be gt or equal to the length of the link table).
*************************/
